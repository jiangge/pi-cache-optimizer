 ...
 *
 * Also documents the before_provider_request retention logic and verifies
 * that 400 history is checked BEFORE explicit opt-in. Provider-specific cache
 * key behavior is covered by the direct hook test in the Pi 0.82 review task.
 */
...
const gateTestCases: Array<{
  ...
  },
  {
    ...
    hasExplicitOptIn: false,
    expectedKeep: false,
    reason: "Gate 4: No opt-in → strip (prevents 400 for third-party models)",
  },
  {
